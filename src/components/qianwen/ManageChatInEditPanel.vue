...
/* 按钮样式 */
.manage-btn {
  @apply w-[150px] text-black flex flex-row justify-start items-center  p-4 px-2 border-none shadow-none rounded-sm bg-white hover:bg-[rgb(68,51,255,0.1)] hover:text-[rgb(68,51,255)];
}
