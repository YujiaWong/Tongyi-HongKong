        ...
        <div class="right h-[650px] flex flex-col justify-between pl-4 gap-4">
          <div>
            <div class="flex justify-between items-center gap-11 relative">
              ...
              <div class="flex justify-center items-center gap-2">
                <!-- <div class="ellipsisHolder">
                  <button
                    class="ellipsisBtn w-[40px] h-[40px] rounded-full bg-gray-100 hover:text-[rgb(72,72,237)]"
                  >
                    <p class="mb-2">...</p>
                  </button>
                  <div
                    class="ellipsisBoard w-[150px] h-[100px] rounded-3xl bg-white absolute shadow-lg top-[50px] right-[40px] p-2"
                  >
                    <button
